...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'null' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'null' ),
		'repeat-y'  => __( 'Repeat Vertically', 'null' ),
		'repeat'    => __( 'Repeat All', 'null' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'null' ),
		'top center'    => __( 'Top Center', 'null' ),
		'top right'     => __( 'Top Right', 'null' ),
		'center left'   => __( 'Middle Left', 'null' ),
		'center center' => __( 'Middle Center', 'null' ),
		'center right'  => __( 'Middle Right', 'null' ),
		'bottom left'   => __( 'Bottom Left', 'null' ),
		'bottom center' => __( 'Bottom Center', 'null' ),
		'bottom right'  => __( 'Bottom Right', 'null')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'null' ),
		'fixed'  => __( 'Fixed in Place', 'null')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'null' ),
		'italic'      => __( 'Italic', 'null' ),
		'bold'        => __( 'Bold', 'null' ),
		'bold italic' => __( 'Bold Italic', 'null' )
		);
